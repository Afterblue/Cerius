...
CERIUS_API bool list_add(List*, int, void*);
...
CERIUS_API bool list_remove(List*, void*, int (*)(void*, void*));
CERIUS_API void* list_get(List*, int);
CERIUS_API int list_find(List*, void*, int (*)(void*, void*));
CERIUS_API bool list_sort(List*, int (*)(void*, void*));
